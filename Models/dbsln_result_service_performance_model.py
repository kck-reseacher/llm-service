...
class DBSLNResultServicePerformance(Base):
    __tablename__ = 'dbsln_result_service_performance'
    ...
    __table_args__ = (
        PrimaryKeyConstraint('time', 'target_id', 'metric', name='dbsln_result_service_performance_pk'),
    )